...
try:
    # load from subfolder 'images'
    img_path = os.getcwd()+"\\images"
    background = pygame.image.load(os.path.join(img_path,"background.jpg"))
    ball = pygame.image.load(os.path.join(img_path,"snake.png"))
    apple = pygame.image.load(os.path.join(img_path,"apple.png"))
except:
    warnings.warn("Unable to find the images in the folder 'data' :-( ")  
...
class App:
    ...
    def on_init(self):
        ...
        pygame.display.set_caption('Pygame Snake vPatxi')
        self._running = True
        self._image_surf = background.convert()
        self._image_surf = ball.convert()
        self._apple_surf = apple.convert()
    ...
    def on_loop(self):
        ...
        for i in range(2,self.player.length):
            ...
            print(i)
            print(self.player.x[i])
            print(self.player.y[i])
